<?php
	...
	if ($type == 'custom') {
		$message_id = uniqid( "brainbizz_message_" );
	...
	// Render Google Fonts
	extract( BrainBizz_GoogleFontsRender::getAttributes( $atts, $this, array('google_fonts_title', 'google_fonts_text') ) );
	...
	// render html
	$output .=  '<div '.esc_attr($message_id_attr).' class="brainbizz_module_message_box'.esc_attr($message_wrap_classes).'">';

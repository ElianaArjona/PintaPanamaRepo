<?php
	...
	// Render Google Fonts
	extract( BrainBizz_GoogleFontsRender::getAttributes( $atts, $this, array('google_fonts_text') ) );
	...
	if(!empty($content)){
		echo '<div class ="brainbizz_module_text'.esc_attr($class).'"'.(!empty($style) ? ' style="'.$style.'"' : '').'>';

		...
		*/	    
		...
		public function header_bar_button($k = null){
			...
			*/
			...
			$link = !empty($link) && $link !== '#' ? 'url:'.urlencode($link).'|title:'.$button_text.'|target:%20_blank|' : '#';
			...
			switch (true) {
				case $location == 'bottom':
					if (!empty($header_logo_src)) {
						?>
						<img class="default_logo" src="<?php echo esc_url($header_logo_src); ?>" alt="<?php echo esc_attr($def_img_alt); ?>"<?php echo BrainBizz_Theme_Helper::render_html($logo_height_style);?>>
					<?php
					}else{
						?>
						<h1 class="logo-name">
				...
				case !empty($logo_sticky_src) && $location == 'sticky':
					?>
					<img class="logo-sticky" src="<?php echo esc_url($logo_sticky_src);?>" alt="<?php echo esc_attr($sticky_img_alt); ?>"<?php echo BrainBizz_Theme_Helper::render_html($sticky_height_style);?>>
					<?php
					break;

				case !empty($logo_mobile_src) && $location == 'mobile':
					?>
					<img class="logo-mobile" src="<?php echo esc_url($logo_mobile_src);?>" alt="<?php echo esc_attr($mobile_img_alt); ?>"<?php echo BrainBizz_Theme_Helper::render_html($mobile_height_style);?>>
					<?php
					break;

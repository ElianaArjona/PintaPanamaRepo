...
if (!class_exists('BrainBizz_header_mobile')) {
	class BrainBizz_header_mobile extends BrainBizz_get_header{
		...
		public function __construct(){
			$this->header_vars();  
	   		...
	   		$header_mobile_background = BrainBizz_Theme_Helper::get_option('mobile_background');
	   		$header_mobile_color = BrainBizz_Theme_Helper::get_option('mobile_color');
		...
		public function default_header_mobile(){
			$mobile_height = BrainBizz_Theme_Helper::get_option('header_mobile_height');
			$mobile_height_style = '';
				...
				echo "<div class='fullwidth-wrapper'>";
					echo "<div class='wgl-header-row_wrapper'".$mobile_height_style.">";
						...
						echo "<div class='header_side display_grow v_align_middle h_align_right'>";
							echo "<div class='header_area_container'>";
								echo BrainBizz_Theme_Helper::render_html($this->search('mobile', '', 'mobile'));
							echo "</div>";
						echo "</div>";				
					echo "</div>";				
				echo "</div>";				

<?php
	...
	if(!empty($apply_animation)){
	    ...
	    $data_attr_content = ' data-center="opacity: 1" data-'.$page_title_top.'-top="opacity: 1" data-0-top="opacity: 0" data-anchor-target=".blog-post-single-item .blog-post_content"';	

<?php
    ...
    extract( BrainBizz_GoogleFontsRender::getAttributes( $atts, $this, array('google_fonts_countdown') ) );
    ...
    $data_array['labels'][]  =  esc_attr( esc_html__('Years', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Months', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Weeks', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Days', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Hours', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Minutes', 'brainbizz') );
    $data_array['labels'][]  =  esc_attr( esc_html__('Seconds', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Year', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Month', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Week', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Day', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Hour', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Minute', 'brainbizz') );
    $data_array['labels1'][] =  esc_attr( esc_html__('Second', 'brainbizz') );

    $data_attribute = json_encode($data_array, true);

    echo '<div '.$countdown_attr.' class="brainbizz_module_countdown'.esc_attr($countdown_class).'" data-atts="'.esc_js($data_attribute).'" style="'.esc_attr($countdown_style).'">';
    echo '</div>';
